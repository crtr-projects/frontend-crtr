    ...
    <div class="footer-content">
      <div class="footer-contact">
        <a href="https://wa.me/5527997725101" target="_blank" class="footer-link">
          <img src="../assets/logos/chamada-telefonica-icon.svg" alt="Telefone" class="footer-icon"/> +55 27 99772-5101
        </a>
      </div>
      <div class="footer-social">
        ...
        <a href="facebook.com/circuitotrproducoes?mibextid=LQQJ4d" target="_blank" class="footer-social-link">
        ...
        <a href="https://www.instagram.com/circuitotrproducoesoficial?utm_source=qr" target="_blank" class="footer-social-link">
          <img src="../assets/logos/instagram-logo.svg" alt="Instagram" class="footer-social-icon"/>
        </a>
        <a href="https://youtube.com/@circuitotrproducoesoficial" target="_blank" class="footer-social-link">
